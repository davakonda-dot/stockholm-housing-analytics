...
## BUGS
   ...
   2) Second bug - when you try to click the dots in POWER BI, it doesnt show apartments from the certain district, it just summarize the cost of the all apartments for rent in the distict. I also haven't managed to fix it too(
